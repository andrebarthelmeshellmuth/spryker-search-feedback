...
{
    /**
     * Only registered when SearchFeedbackConstants::IS_CHECK_INSTALLATION_PAGE_ENABLED is on — this demoshop
     * enables it in config/Shared/config_default-docker.dev.php.
     *
     * @var string
     */
    public const URL = '/search-feedback-widget/check-installation';
     ...
     * @var string
     */
    public const PERMISSION_DENIED_HEADING = 'Search Feedback: permission required';
}
