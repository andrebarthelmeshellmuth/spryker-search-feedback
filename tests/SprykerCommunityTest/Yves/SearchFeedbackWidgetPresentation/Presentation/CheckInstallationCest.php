...
use SprykerCommunityTest\Yves\SearchFeedbackWidgetPresentation\PageObject\CheckInstallationPage;
...
class CheckInstallationCest
{
     ...
     * @param \SprykerCommunityTest\Yves\SearchFeedbackWidgetPresentation\SearchFeedbackWidgetPresentationTester $i
     */
    public function loggedOutVisitorSeesPermissionDenied(SearchFeedbackWidgetPresentationTester $i): void
    {
     ...
     * @param \SprykerCommunityTest\Yves\SearchFeedbackWidgetPresentation\SearchFeedbackWidgetPresentationTester $i
     */
    public function permittedCustomerSeesTheRealChecklist(SearchFeedbackWidgetPresentationTester $i): void
    {
     ...
     * @param \SprykerCommunityTest\Yves\SearchFeedbackWidgetPresentation\SearchFeedbackWidgetPresentationTester $i
     */
    public function everyFailedCheckRendersARemedy(SearchFeedbackWidgetPresentationTester $i): void
    {
        $i->loginAsCustomer(SearchFeedbackWidgetPresentationTester::PERMITTED_CUSTOMER_EMAIL);
        $i->amOnPage(CheckInstallationPage::URL);
