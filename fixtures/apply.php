 ...
 *
 * Grants the SubmitSearchFeedbackTicketPermissionPlugin permission to a real, loggable-in customer
 ...
 * sibling search-debug/search-ranking/search-ranking-optimizer packages (same account, one role per
...
$permissionRowsAdded += (int)applyPermissionRow($dataDir, 'test-company_Admin', 'SubmitSearchFeedbackTicketPermissionPlugin');
$permissionRowsAdded += (int)applyPermissionRow($dataDir, 'test-company_Admin', 'ViewSearchFeedbackTicketReplayPermissionPlugin');
echo "company_role_permission.csv: $permissionRowsAdded row(s) added\n";
