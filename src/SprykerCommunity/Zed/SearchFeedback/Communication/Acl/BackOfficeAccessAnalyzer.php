...
namespace SprykerCommunity\Zed\SearchFeedback\Communication\Acl;

use Generated\Shared\Transfer\RuleTransfer;
use Generated\Shared\Transfer\SearchFeedbackBackOfficeAccessDiagnosisTransfer;
...
class BackOfficeAccessAnalyzer implements BackOfficeAccessAnalyzerInterface
{
    ...
    /**
     * @param \SprykerCommunity\Zed\SearchFeedback\Dependency\Facade\SearchFeedbackToAclFacadeInterface $aclFacade
     */
    public function __construct(protected SearchFeedbackToAclFacadeInterface $aclFacade)
    {
    }
     ...
     */
    public function analyze(array $moduleNames): SearchFeedbackBackOfficeAccessDiagnosisTransfer
    {
        $diagnosisTransfer = new SearchFeedbackBackOfficeAccessDiagnosisTransfer();
     ...
     * controller/action (this package's own README suggests exactly that, to keep status changes away from
     * a read-only role) leaves the rest of the module reachable, and must not read as "no access".
     *
     * @param \Generated\Shared\Transfer\RuleTransfer $ruleTransfer
     */
